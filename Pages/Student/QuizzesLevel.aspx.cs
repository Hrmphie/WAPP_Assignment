...
{
    public partial class QuizzesLevel : Page
    {
        ...
        {
            Response.Redirect("~/Pages/Student/QuizzesPage.aspx?level=1");
        }
        ...
        {
            Response.Redirect("~/Pages/Student/QuizzesPage.aspx?level=2");
        }
        ...
        {
            Response.Redirect("~/Pages/Student/QuizzesPage.aspx?level=3");
        }
    }
}